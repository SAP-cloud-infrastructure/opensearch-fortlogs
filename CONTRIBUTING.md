...
# Contributing to opensearch-fortlogs

Thank you for your interest in contributing to opensearch-fortlogs! This document explains how to get involved.

## Reporting Bugs

Please open a [GitHub issue](https://github.com/SAP-cloud-infrastructure/opensearch-fortlogs/issues) with:
...
```bash
# Build
docker build --platform linux/amd64 -t opensearch-fortlogs:<tag> .
```
