...
`opensearchproject/opensearch:3.8.0` (linux/amd64)
...
| opensearch-project/security-analytics | PR | [#1827](https://github.com/opensearch-project/security-analytics/pull/1827) | fix(rules): emit native wildcard DSL for wildcard-typed fields |
| opensearch-project/security-analytics | Issue | [#1826](https://github.com/opensearch-project/security-analytics/issues/1826) | Bucket-level monitor filter silently returns 0 hits for wildcard-typed fields |
...
| opensearch-project/security-analytics | Issue | [#1796](https://github.com/opensearch-project/security-analytics/issues/1796) | fix: NullPointerException in RuleIndices when log type has no field mappings, and UnsupportedOperationException risk in CustomLogType from immutable map deserialization |
...
| opensearch-project/common-utils | PR | [#967](https://github.com/opensearch-project/common-utils/issues/967) | Fix ClassCastException from immutable map returned by StreamInput.readMap() |
| opensearch-project/common-utils | Issue | [#968](https://github.com/opensearch-project/common-utils/pull/968) | Fix ClassCastException from immutable map returned by StreamInput.readMap() |
