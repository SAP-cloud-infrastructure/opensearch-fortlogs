...
| opensearch-project/security-analytics | PR | [#1804](https://github.com/opensearch-project/security-analytics/pull/1804) | fix: guard against null and immutable map returns in RuleIndices and CustomLogType |
