...
| opensearch-project/alerting | Issue | [#22222(https://github.com/opensearch-project/alerting/issues/2222) | [BUG] Doc-level monitor with multiple triggers generates duplicate findings per matched document |
