...
RUN curl -fsSL https://github.com/SAP-cloud-infrastructure/opensearch-alerting/releases/download/3.7.0.0-sci-v6/opensearch-alerting-3.7.0.0-sci-v6-SNAPSHOT.zip -o /tmp/opensearch-alerting.zip \
 && curl -fsSL https://github.com/SAP-cloud-infrastructure/opensearch-security-analytics/releases/download/3.7.0.0-sci-v4/opensearch-security-analytics-3.7.0.0-sci-v4.zip -o /tmp/opensearch-security-analytics.zip \
